...
using UserViewModel = EntityLayer.ViewModels.UserViewModel;
...
namespace TermProject.Controllers
{
    ...
    public class MemberController : Controller
    {
        ...
        public async Task<IActionResult> MemberEdit()
        {
        ...
        [HttpPost]
        public async Task<IActionResult> MemberEdit(UserEditViewModel request)
        {
            if (!ModelState.IsValid)
            {
                return View();
